...
export const RECEIVE_GOODS = 'receive_goods' // 商家商品
export const RECEIVE_RATINGS = 'receive_ratings' // 商家评价
export const RECEIVE_INFO = 'receive_info' // 商家详情
export const INCREMENT_FOOD_COUNT = 'increment_food_count' // 增加food中count
export const DECREMENT_FOOD_COUNT = 'decrement_food_count' // 减少food中count
